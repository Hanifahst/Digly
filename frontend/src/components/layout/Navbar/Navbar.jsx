    ...
    <header className="sticky top-0 z-50 border-b border-[#E7DDD0] bg-[#F8F5F0]/95 backdrop-blur">
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-8 text-sm font-medium text-[#6B5B4D] md:flex">
          <Link to="/" className="transition hover:text-[#8B6F47]">
            Home
          </Link>

          <Link to="/books" className="transition hover:text-[#8B6F47]">
            Books
          </Link>

          <Link to="/history" className="transition hover:text-[#8B6F47]">
            History
          </Link>

          <Link to="/profile" className="transition hover:text-[#8B6F47]">
            Profile
          </Link>
        </div>
